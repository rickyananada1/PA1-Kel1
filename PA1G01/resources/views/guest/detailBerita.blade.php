...
@section('title')
    Detail Berita Satuan Pengawas Internal - IT DEL
@endsection
                ...
                <div class="col-lg-8">
                    <div class="row g-2">
                        ...
                        <div class="blog-img position-relative overflow-hidden">
                            @php
                                $resizedImage = Image::make(public_path('uploads/berita/' . $berita->gambar_berita))->resize(660, null, function ($constraint) {
