                ...
                <div class="card full-height">
                    ...
                    <div class="card-body">
                        <form action="{{ route('berita.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
                                <label for="judul" class="form-label">{{ __('Judul Berita') }}</label>
                            ...
                            <div class="mb-3">
                                <label for="kategori" class="form-label">{{ __('Kategori Berita') }}</label>
                            ...
                            <div class="mb-3">
                                <label for="gambar" class="form-label">{{ __('Gambar Berita') }}</label>
