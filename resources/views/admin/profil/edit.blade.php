                        ...
                        @foreach ($profil as $row)
                            <form action="{{ route('profil.update', $row->id) }}" method="POST">
                                ...
                                <div class="form-group row">
                                    <label for="nama" class="col-sm-3 col-form-label">{{ __('Nama Lengkap') }}</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    <label for="no_telepon" class="col-sm-3 col-form-label">{{ __('No. Telepon') }}</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" value="{{  Auth::user()->alamat }}" id="alamat" name="alamat" placeholder="{{ __('Alamat') }}">
                                        @error('alamat')
                                            <span class="text-danger mt-2">{{ $message }}</span>
                                        @enderror
                                    </div>
