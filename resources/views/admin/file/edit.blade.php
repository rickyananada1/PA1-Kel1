...
@section('title')EDIT FILE @endsection
@section('content')
    <div class="container">
                ...
                <div class="card full-height">
                    ...
                    <div class="card-body">
                        <form action="{{ route('file.update', $file->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            @method('put')
                            <div class="mb-3">
                                <label for="namaFile" class="form-label">{{ __('Nama File') }}</label><span aria-hidden="true"
                                ...
                                <input type="text" name="namaFile" class="form-control" id="namaFile"
                                    placeholder="Enter Nama file" value={{ old('namaFile', $file->namaFile) }}>
                                @error('namaFile')
