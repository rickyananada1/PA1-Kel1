...
@section('title')EDIT KATEGORI PELAPOR @endsection
@section('content')
    <div class="container">
                    ...
                    <div class="card-body">
                        <form action="{{ route('kategoriPelapor.update', $kategoriPelapor->id) }}" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="nama_kategori" value="{{ old('nama_kategori', $kategoriPelapor->nama_kategori) }}" class="form-control" id="kategori" placeholder="Enter kategori">
                                @error('nama_kategori')
