...
@section('title')CREATE KATEGORI PELAPOR @endsection
@section('content')
    <div class="container">
                ...
                <div class="card full-height">
                    <div class="card-header">
                        <div class="card-head-row d-flex">
                            ...
                            <a href="{{ route('kategoriPelapor.index') }}" class="btn btn-warning btn-sm ml-auto "><i class="fa-solid fa-backward"></i></a>
                        </div>
                    </div>
                    <div class="card-body">
