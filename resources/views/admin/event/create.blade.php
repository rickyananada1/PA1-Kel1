                ...
                <div class="card full-height">
                    <div class="card-header">
                        <div class="card-head-row d-flex">
                            <div class="card-title">{{ __('Form Event') }}</div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('event.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
                                <label for="judul" class="form-label">{{ __('Judul Event') }}</label>
                            ...
                            <div class="mb-3">
                                <label for="body" class="form-label">{{ __('Deskripsi') }}</label>
                            ...
                            <div class="mb-3">
                                <label for="gambar" class="form-label">{{ __('Gambar Event') }}</label>
                                <input type="file" name="gambar_event" class="form-control-file" id="gambar">
                                @error('gambar_event')
                                    <span class="text-danger mt-2">{{ $message }}</span>
                                @enderror
                            </div>
